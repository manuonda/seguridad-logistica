                                ...
                                <div class="card card-outline-secondary">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" name="num_prontuario" id="num_prontuario" class="form-control mayuscula" value="<?php if (isset($num_prontuario)) echo $num_prontuario; ?>" placeholder="Nro. de Prontuario" required spellcheck="false" <?php echo $disabled; ?> />
                                            </div>
                                            <div class="col-sm-1">
                                          ...
                                          <!-- valores derecho 
                                          <input type="text" name="pulgar_d_id" value="<?php  echo $pulgar_d_id ;?>">
                                          <input type="text" name="derecho_1_id" value="<?php echo $derecho_1_id ;?>">
                                          <input type="text" name="derecho_2_id" value="<?php echo $derecho_2_id ;?>">
                                          <input type="text" name="derecho_3_id" value="<?php echo $derecho_3_id ;?>">
                                          <input type="text" name="derecho_4_id" value="<?php echo $derecho_4_id ;?>">
                                          <div class="row">
                                           <div class="col-md-3">
                                           <label>Pulgar</label>
                                           <select name="pulgar_d" id="id_localidad" class="form-control" data-toggle="tooltip" data-placement="bottom" required>
                                            <option value="">-- SELECCIONAR --</option>
                                              <?php foreach ($valores_pulgares as $item) : ?>
                                               <option value="<?php echo $item ?>" <?php if (isset($pulgar_derecho) && $id_localidad == $item) echo 'selected="selected"'; ?>><?php echo $item ?></option>
                                             <?php endforeach; ?>
                                             </select> 
                                           </div>
                                           ...
                                           <div class="col-md-3">
                                           <label>Valor 1</label>
                                           <select name="derecho_1" id="derecho_1" class="form-control" data-toggle="tooltip" data-placement="bottom" required>
                                            <option value="">-- SELECCIONAR --</option>
                                              <?php foreach ($valores_dedos as $item) : ?>
                                               <option value="<?php echo $item ?>" <?php if (isset($derecho_1) && $derecho_1 == $item) echo 'selected="selected"'; ?>><?php echo $item ?></option>
                                             <?php endforeach; ?>
                                             </select> 
                                           </div>
                                           ...
                                           <div class="col-md-3">
                                           <label>Serie</label>
                                           <select name="derecho_2" id="derecho_2" class="form-control" data-toggle="tooltip" data-placement="bottom" required>
                                            <option value="">-- SELECCIONAR --</option>
                                              <?php foreach ($valores_dedos as $item) : ?>
                                               <option value="<?php echo $item ?>" <?php if (isset($derecho_2) && $derecho_2 == $item) echo 'selected="selected"'; ?>><?php echo $item ?></option>
                                             <?php endforeach; ?>
                                             </select> 
                                           </div> 
                                           ...
                                           <div class="col-md-3">
                                           <label>Serie</label>
                                           <select name="derecho_3" id="derecho_3" class="form-control" data-toggle="tooltip" data-placement="bottom" required>
                                            <option value="">-- SELECCIONAR --</option>
                                              <?php foreach ($valores_dedos as $item) : ?>
                                               <option value="<?php echo $item ?>" <?php if (isset($derecho_3) && $derecho_3 == $item) echo 'selected="selected"'; ?>><?php echo $item ?></option>
                                             <?php endforeach; ?>
                                             </select> 
                                           </div> 
                                           ...
                                           <div class="col-md-3">
                                           <label>Serie</label>
                                           <select name="derecho_4" id="derecho_4" class="form-control" data-toggle="tooltip" data-placement="bottom" required>
                                            <option value="">-- SELECCIONAR --</option>
                                              <?php foreach ($valores_dedos as $item) : ?>
                                               <option value="<?php echo $item ?>" <?php if (isset($derecho_4) && $derecho_4 == $item) echo 'selected="selected"'; ?>><?php echo $item ?></option>
                                             <?php endforeach; ?>
                                             </select> 
                                           </div> 
