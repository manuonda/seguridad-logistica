    ...
    <div class="col-md-12">
        ...
        <div class="card card-outline-secondary">
            <div class="card-header text-center">
                <h5 class="mb-0"><b>Carga de datos para cupon de pago de REBA</b></h5>
            </div>
           <form action="<?php echo base_url().'/tramiteReba/guardar'; ?>" method="post" id="form">            
            <div class="card-body">
            <?php if ( isset($status) && $status == 'ERROR') { ?>
              ...
              <?php }?>
                    ...
                    <input type="hidden" name="id_tramite_reba" id="id_tramite_reba" value="<?php if( isset($id_tramite_reba)) echo $id_tramite_reba; ?>" />
            		...
            		<div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="nombre" id="nombre" class="form-control mayuscula" 
                             ...
                             placeholder="Ingrese nombre" required spellcheck="false" />
                        </div>
                    </div>
            		<div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="apellido" id="apellido" class="form-control mayuscula" 
                             ...
                             placeholder="Ingrese apellido" required spellcheck="false" />
                        </div>
                    </div>                                        
            		<div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="telefono" id="telefono" class="form-control mayuscula" 
                             ...
                             placeholder="Ingrese telefono" required spellcheck="false" />
                        </div>
                    </div>
            		<div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="email" id="email" class="form-control" 
                             ...
                             placeholder="Ingrese email" required spellcheck="false" />
                        </div>
                    </div>                                                                                                                        
                    <div class="form-group row">
                   ...
                   <div class="form-group row" id="cuil">
                    <label class="col-lg-3 col-form-label form-control-label">CUIL *:</label>
                       <div class="col-lg-5">
                            <input type="text" name="cuil" id="cuil" class="form-control mayuscula" 
                             value="<?php if(isset($cuil)) echo $cuil; ?>" 
                             placeholder="cuil"  spellcheck="false" />
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 control-label" for="categoria_reba">Categoria REBA *:</label>
                        <div class="col-lg-9">
                           <select id="id_categoria_reba" name="id_categoria_reba" class="form-control" data-toggle="tooltip" data-placement="bottom">
                             <option value="">-- SELECCIONAR --</option>
                              <?php foreach ($categorias as $item) : ?>
                              <option value="<?php echo $item['id'] ?>" <?php if (isset($id_categoria_reba) && $id_categoria_reba == $item['id']) echo 'selected="selected"'; ?>><?php echo $item['nombre'] ?></option>
                              <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 control-label" for="en_concepto_de">En concepto de: </label>
                        <div class="col-lg-9">
                            <input type="text" name="en_concepto_de" id="en_concepto_de" class="form-control mayuscula" 
                             ...
                             placeholder="Ingrese En concepto de" required spellcheck="false" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 control-label" for="categoria_reba">Denominación Negocio :</label>
                        <div class="col-lg-9">
                            <input type="text" name="denominacion_negocio" id="denominacion_negocio" class="form-control mayuscula" 
                    ...
                    <div class="row">
                         <div class="form-group col-md-6">
                            <label class=" control-label " for="categoria_reba">Concepto Pago Uno :</label>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="precio_uno" id="precio_uno" class="form-control" 
                               oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                               value="<?php if(isset($precio_uno)) echo $precio_uno; ?>" 
                               placeholder="Precio" required spellcheck="false" />
                        </div>
                    </div>
                    <!-- Parte de Pago Dos -->
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="precio_dos" 
                               ...
                               value="<?php if(isset($precio_dos)) echo $precio_dos; ?>" 
                               placeholder="Precio" required spellcheck="false" />
                        </div>
                    </div>
                    <!-- Parte de Pago tres -->
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="precio_tres" id="precio_tres" class="form-control" 
                               oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                               value="<?php if(isset($precio_tres)) echo $precio_tres; ?>" 
                               placeholder="Precio" required spellcheck="false" />
                        </div>
                    </div>
...
function validar() {
    ...
    var id_categoria_reba = $("#id_categoria_reba").val().trim();
    if (id_categoria_reba == '') {
        showAlert("Debe ingresar la Categoria de REBA");
        return;
    }    
    return true;
}
