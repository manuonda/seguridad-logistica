...
<div class="col-md-12">
    ...
    <div class="card card-outline-secondary">
        <div class="card-body">
            ...
            <div class="form-group row">
                <label class="col-lg-12 control-label fs-title"><b>Tutor solicitante (para los menores de edad cargar los datos del tutor)</b></label>
            </div>
            <div class="form-group row">
...
<script>
   ...
   function eliminarFoto(parameter) {
    ...
    /**Funcion que permite realizar la validacion 
     * de los datos.
     */
    function validar() {
        if ($("#nombre").val().trim() == '') {
...
//         }
    ...
    /*function validarArchivo() {
        ...
        var allowedExtensions1 = /(\.jpg|\.jpeg|\.png|\.pdf)$/i;
        if (fileInput != ''){
            if (!allowedExtensions.exec(filePath)) {
                alert('Solo se permiten archivos PNG, JPEG, JPG y PDF');
                fileInput.value = ''; //Limpia el input de frentedocumento
                fileInput1.value = ''; //Limpia el input de dorsodocumento
                return;
            }/* else {
        ...
        /*} else {
            //if (fileInput1 != '') {
                /*if (!allowedExtensions.exec(filePath)) {
                    alert('Solo se permiten archivos PNG, JPEG, JPG y PDF');
                    fileInput.value = ''; //Limpia el input de dorsodocumento
                    return;
                } else {*/
