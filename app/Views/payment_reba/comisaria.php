...
<div class="alert alert-info alert-dismissible">
    ...
    <div class="alert alert-secondary" role="alert">
    	Una vez realizado el pago en la Comisaría seleccionada y validado sus datos, el certificado le llegará al número por whatsapp y al email indicado en el paso 1. Muchas gracias!!!
    <!-- 
