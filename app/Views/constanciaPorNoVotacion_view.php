    ...
    <div class="card card-outline-secondary">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                 <select readonly class="form-control" data-toggle="tooltip" 
                 data-placement="bottom" required>
                        <option value="">-- SELECCIONAR --</option>
                        <?php foreach ($razones as $key => $value) : ?>
                            <option value="<?php echo $key ?>" <?php if (isset($dataInformation['razon_social']) && $dataInformation['razon_social'] == $key) echo 'selected="selected"'; ?>><?php echo $value ?></option>
                        <?php endforeach; ?>
                 </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" readonly class="form-control mayuscula"
                     value="<?php if (isset($dataInformation['descripcion'])) echo $dataInformation['descripcion']; ?>" placeholder="DESCRIPCIÓN DEL MOTIVO" required spellcheck="false" />
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="date" readonly class="form-control mayuscula" 
                    value="<?php if (isset($dataInformation['fecha_votacion'])) echo $dataInformation['fecha_votacion']; ?>" required spellcheck="false" />
                </div>
            </div>
                ...
                <div class="col-lg-9">
                 ...
                 data-placement="bottom" >
                        ...
                        <?php foreach ($provincias as $item) : ?>
                            <option value="<?php echo $item['id_provincia'] ?>" <?php if (isset($dataInformation['id_provincia']) && $dataInformation['id_provincia'] == $item['id_provincia']) echo 'selected="selected"'; ?>><?php echo $item['nombre'] ?></option>
                        <?php endforeach; ?>
                 </select>
                </div>
            </div>
