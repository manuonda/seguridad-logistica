    ...
    <div class="card card-outline-secondary">
        <div class="card-body">
    		<div class="bs-component text-center">
                <h3><b>Ver turnos de Planilla Prontuarial</b></h3><br/>
            </div>
            <form action ="<?php echo base_url('dap/buscar'); ?>" method="POST" id="myForm">
            <div class="row">
                 ...
                 <div class="row">
                 <div class="form-group col-md-4">
                    <label for="exampleInputEmail1">Fecha Turno</label>
                ...
                <div class="col-md-12 text-center"><br/>
                    ...
                    <?php if (!empty($listado)): ?>
                        <a class="btn btn-info" href="<?= base_url('/dap/pdf')?>" target="_blank"><span class="oi oi-print"></span> Imprimir listado</a>
                        <a class="btn btn-success" href="<?= base_url('/dap/pdf2')?>" target="_blank"><span class="oi oi-print"></span> Cupones</a>
                    <?php endif; ?>
                </div>
            ...
            <div id="no-more-tables" class="table-responsive">
                <table id="tabla" border="1" cellspacing="0" cellpadding="0" class="dataTable table display compact table-bordered table-striped table-condensed table-hover cf" width="100%">
                    <thead class="cf">
                    <tr>
                        <th>N° trámite</th>
                        <th>Fecha</th>
                        ...
                        <tr>
                            ...
                            <td data-title="Acción">
                            	<?php if(empty($item['estado_verificacion']) || $item['estado_verificacion']==TRAMITE_PENDIENTE_VERIFICACION) { ?>
                            	 	<a href="<?php echo base_url(); ?>/<?php echo $item['controlador']; ?>/verificar/<?php echo $item['id_tramite']; ?>/dapTurno" class="btn btn-primary" style="padding: .315rem .25rem;">Verificar</a>
                            	<?php }else { ?>
                            		<a href="<?php echo base_url(); ?>/<?php echo $item['controlador']; ?>/verificar/<?php echo $item['id_tramite']; ?>/dapTurno" class="btn btn-info" style="padding: .315rem .25rem;">Ver</a>
...
<script type="text/javascript">
    function resetForm(){
        ...
        document.getElementById("fecha_turno").value = new Date();
    }
</script>