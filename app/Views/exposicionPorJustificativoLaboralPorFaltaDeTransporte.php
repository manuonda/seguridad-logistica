    ...
    <div class="card card-outline-secondary">
        <div class="card-body">
            ...
            <div class="form-group row">
                <img src="<?php echo base_url('assets/img/baner-exp-laboral.jpg'); ?>" alt="Imagen" width="500px" height="400px" />
            </div>
            <div class="form-group row">
...
<script>
    function validar() {
        ...
        if ($("#profesion").val().trim() == '') {
            showAlert("Debe ingresar su profesión", "profesion");
            return;
        }
        if ($("#lugar_de_trabajo").val().trim() == '') {
            showAlert("Debe ingresar el lugar donde trabaja", "lugar_de_trabajo");
            return;
        }
        if ($("#empresa_transporte").val().trim() == '') {
            showAlert("Debe ingresar la empresa de transporte en que viaja", "empresa_transporte");
            return;
        }
        ...
        if ($("#fecha_paro_transporte").val().trim() == '') {
            showAlert("Debe ingresar la Fecha de paro del transporte que necesita justificar.", "fecha_paro_transporte");
            return;
        }
