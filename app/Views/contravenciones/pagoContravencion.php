<div class="container" style="padding-top: 70px">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-outline-secondary">
            ...
            <form action="<?php echo base_url().'/pagoContravencion/verificar'; ?>" method="post" id="form">
                <div class="card-body">
                    <!-- *************************************** -->
                    <?php if ( isset($status)) { ?>
                    <?php if ($status == 'ERROR') { ?>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12 text-center">
                            ...
                            <button class="btn btn-primary" type="button" id="btnReiniciar" onclick="enviar()"><span
                                    class="oi oi-reload"></span> Buscar</button>
                        </div>
                    </div>
                ...
                <input type="hidden" name="porque_motivo" id="porque_motivo"
                    value="<?php if (isset($porque_motivo)) echo $porque_motivo; ?>">
                <?php echo form_close(); ?>
        </div>
    </div>
</div>

<!-- Formulario de pago de Banco Macro -->
<!-- <form method="post" id="formBancoMacro" action="https://sandboxpp.asjservicios.com.ar" /> -->
<!-- <form method="post" id="formBancoMacro" action="https://botonpp.asjservicios.com.ar/" /> 
...
function pagarBancoMacro(idTramite) {
    ...
    //
    fetch(baseUrl + '/pagoContravencion/pagoBancoMacro/' + idTramite + '/' + true + '/contravencion')
