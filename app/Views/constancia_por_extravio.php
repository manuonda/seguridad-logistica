        ...
        <div class="card card-outline-secondary">            
            <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control mayuscula" value="<?php if (isset($fecha_nacimiento)) echo $fecha_nacimiento; ?>" placeholder="Fecha Nacimiento" required spellcheck="false" />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <?php //if (empty($id_tipo_documento) || (!empty($id_tipo_documento) && $id_tipo_documento==1)) { ?>
                        <div class="form-group row" id="divNroTramiteDni">
                            ...
                            <div class="col-lg-5">
                                <input type="text" name="nro_tramite_dni" id="nro_tramite_dni" class="form-control mayuscula" value="<?php //if (isset($nro_tramite_dni)) echo $nro_tramite_dni; ?>" placeholder="Ingresá los 11 dígitos de tu número de trámite" maxlength="11" spellcheck="false" />
                            </div>
                            <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label form-control-label"></label>
                        <div class="col-lg-9">
                            <textarea class="form-control mayuscula" name="elementos_extraviados" id="elementos_extraviados" rows="6" placeholder="Elemento/s extraviado/s" required data-toggle="tooltip" data-placement="bottom" spellcheck="false"><?php if(isset($elementos_extraviados)) echo $elementos_extraviados; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
