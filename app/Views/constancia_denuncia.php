<!--<script src="https://code.jquery.com/jquery-3..1.slim.min.js" integrity="sha384-J6qa4849blE2+poT4WnyKhv5vZF5SrPo0iEjwBvKU7imGFAV0wwj1yYfoRSJoZ+n" crossorigin="anonymous"></script>-->
    ...
    <div class="card card-outline-secondary">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <label class="col-lg-1 col-form-label form-control-label responsive-label" style="padding-right: 0;">Dpto. :</label>
                <div class="col-lg-1">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="date" name="fecha_denuncia" id="fecha_denuncia" class="form-control mayuscula" value="<?php if (isset($fecha_denuncia)) echo $fecha_denuncia; ?>" placeholder="Fecha de la denuncia" required spellcheck="false" />
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label">Hora aproximada que realizó la denuncia *:</label>
                <div class="col-lg-9">
                    <input type="time" name="hora_denuncia" id="hora_denuncia" class="form-control mayuscula" value="<?php if(isset($hora_denuncia)) echo $hora_denuncia; ?>" required spellcheck="false" />
                </div>
            </div>
          
            <?php if (empty($id_tramite) && empty($userInSession)) { ?>
                <div id="div_dependencia" class="form-group row">
                    <label id="label_id_dependencia" class="col-lg-3 control-label" for="id_dependencia">Comisaría donde realizó la denuncia *:</label>
                    <div class="col-lg-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" name="oficial_tomo_denuncia" id="oficial_tomo_denuncia" class="form-control mayuscula" value="<?php if (isset($oficial_tomo_denuncia)) echo $oficial_tomo_denuncia; ?>" placeholder="Oficial que tomó la denuncia" required spellcheck="false" />
                </div>
            </div>
            <?php if (isset($action) && ($action == "edit" || $action == "new") && isset($estados)) { ?>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" name="descripcion_denuncia" id="descripcion_denuncia" placeholder="Texto de la denuncia" rows="10">
                            <?php if(isset($descripcion_denuncia)) echo $descripcion_denuncia; ?>
                        </textarea>
                    </div>
                </div>
                <!-- <script>
                    $(document).ready(function() {
                        $('#descripcion_denuncia').summernote({
                        	height: 350,
                        });
                    });
                </script> -->
                <script>
                    CKEDITOR.replace( 'descripcion_denuncia' );
                </script>
            <?php } ?>
            <div class="form-group row">
...
//         }
       ...
       console.log($("#cke_descripcion_denuncia iframe").contents().find("body").text());

        if ($("#cke_descripcion_denuncia iframe").contents().find("body").text().trim() == '') {
